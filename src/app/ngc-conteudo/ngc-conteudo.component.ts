...
@Component({
  selector: 'app-ngc-conteudo',
  templateUrl: './ngc-conteudo.component.html',
  styleUrls: ['./ngc-conteudo.component.css']
})
export class NgcConteudoComponent implements OnInit {
  users = [
    {
      name: 'Lia Lugo',
      avatar: 'svg-11',
